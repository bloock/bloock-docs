...
export default function CommunitySection() {
  return (
    <section className="no-underline-links">
      <div className="mx-auto flex w-full flex-col items-center justify-center bg-accent px-4 py-16 pt-64 text-white dark:bg-primary dark:text-zinc-700">
        <h2 className="text-3xl text-white">
          Join the <span className="text-bold">community</span>
        </h2>
        ...
        <div className="flex w-full flex-col items-center justify-center gap-2 text-sm font-semibold lg:flex-row lg:gap-8">
          <Link
            className="bg-white-100/10 flex w-full items-center justify-center gap-2 rounded-sm border border-solid border-white px-2 py-2 text-white lg:w-auto"
          ...
          <Link
            className="bg-white-100/10 flex w-full items-center justify-center gap-2 rounded-sm border border-solid border-white px-2 py-2 text-white lg:w-auto"
            href="https://www.linkedin.com/company/bloock"
          >
