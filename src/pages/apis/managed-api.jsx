...
export default function Home() {
  ...
  return (
    <Layout
      title={`Managed API Documentation | BLOOCK Docs`}
      description="Explore the comprehensive API documentation provided by BLOOCK. Learn how to integrate and leverage BLOOCK's Managed API."
      noFooter
    ...
    >
      ...
      <APIElement
        ...
        url={`https://raw.githubusercontent.com/bloock/managed-apis-docs/master/reference/Managed-API.yaml`}
      />
    </Layout>
  );
}
