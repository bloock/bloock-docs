...
BLOOCK's identity product allows you to act as [verification agents](../concepts/protocol.mdx#the-verifier) as well. Once our users or holders have their credentials, they will want to be able to verify themselves.
...
1. You must create a request, which is nothing more than a QR code to show to the user or Holder you want to verify. In order to create the request you need to create a [Validation Query](../concepts/protocol.mdx#verification-queries). This functionality is available in our dashboard.
