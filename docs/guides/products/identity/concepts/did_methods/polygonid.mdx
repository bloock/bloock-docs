...
- It's derived from a [Baby JubJub key](https://docs.iden3.io/publications/pdfs/Baby-Jubjub.pdf) and other cryptographic material. This key can be created with [BLOOCK Keys product](./../../../key/features/key/set-up-managed.mdx) in a managed way or by yourself locally. It will be very important to be able to control your identity.
