...
To start using this method, you will need to [Configure a Webhook](../../webhooks/overview/configure-webhooks.md) on our managment website and selecting one or more networks to wait for.
...
import WaitAnchorJava from '!!raw-loader!@site/examples/integrity/wait_anchor/wait_anchor.java';
