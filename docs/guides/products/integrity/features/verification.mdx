...
import VerifyRecordsJava from '!!raw-loader!@site/examples/integrity/verify_records/verify_records.java';
...
import GetProofJava from '!!raw-loader!@site/examples/integrity/get_proof/get_proof.java';
...
import VerifyProofJava from '!!raw-loader!@site/examples/integrity/verify_proof/verify_proof.java';
...
import VerifyRootJava from '!!raw-loader!@site/examples/integrity/verify_root/verify_root.java';
