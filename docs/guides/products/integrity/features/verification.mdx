...
:::tip
You will not be able to verify a Record that is not fully processed and transacted to Blockchain. See [Synchronization](./synchronization.mdx#synchronization) for information about how to manage it.
:::
