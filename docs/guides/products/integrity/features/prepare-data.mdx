...
import PrepareRecordJs from '!!raw-loader!@site/examples/record/prepare/prepare.ts';
import PrepareRecordPy from '!!raw-loader!@site/examples/record/prepare/prepare.py';
import PrepareRecordJava from '!!raw-loader!@site/examples/record/prepare/prepare.java';
import PrepareRecordPhp from '!!raw-loader!@site/examples/record/prepare/prepare.php';
import PrepareRecordGo from '!!raw-loader!@site/examples/record/prepare/prepare.go';
