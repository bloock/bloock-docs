...
import NewManagedKeyJava from '!!raw-loader!@site/examples/key/new_managed_key/new_managed_key.java';
...
import LoadManagedKeyJava from '!!raw-loader!@site/examples/key/load_managed_key/load_managed_key.java';
