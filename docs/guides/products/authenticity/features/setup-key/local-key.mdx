...
import NewLocalKeyJava from '!!raw-loader!@site/examples/key/new_local_key/new_local_key.java';
...
import LoadLocalKeyJava from '!!raw-loader!@site/examples/key/load_local_key/load_local_key.java';
