...
- **[Cryptographic keys](#what-cryptographic-key)**: software-protected keys that supports multiple types and algorithms.
- **[Certificates](#what-certificate)**: which are built on top of keys. It contains the key and identifiable extra information. when a certificate is created, an addressable key is also created.
