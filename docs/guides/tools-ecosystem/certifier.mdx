...
The Certifier tool allows you to test BLOOCK's suite of products modularly without needing integration. Seal your documents, sign, generate access control mechanisms, and host your documents simply and securely.
...
![1 - Certifier](/static/docs/guides/tools-ecosystem/certifier/1-certifier.png)

![2 - Certifier](/static/docs/guides/tools-ecosystem/certifier/2-certifier.png)

![3 - Certifier](/static/docs/guides/tools-ecosystem/certifier/3-certifier.png)
...
![4 - Certifier](/static/docs/guides/tools-ecosystem/certifier/4-certifier.png)
...
![5 - Certifier](/static/docs/guides/tools-ecosystem/certifier/5-certifier.png)

In the third step of the process with Descentralized Storage, users can activate the option to save the files to ensure their availability. If this option is selected, the system can generate an automatic validation link.

![6 - Certifier](/static/docs/guides/tools-ecosystem/certifier/6-certifier.png)
...
![7 - Certifier](/static/docs/guides/tools-ecosystem/certifier/7-certifier.png)
...
![8 - Certifier](/static/docs/guides/tools-ecosystem/certifier/8-certifier.png)
...
![9 - Certifier](/static/docs/guides/tools-ecosystem/certifier/9-certifier.png)
...
![10 - Certifier](/static/docs/guides/tools-ecosystem/certifier/10-certifier.png)
...
![11 - Certifier](/static/docs/guides/tools-ecosystem/certifier/11-certifier.png)

In the "Availability Details" tab, one can locate the link to the CDN, the file size, and other pertinent details.

![12 - Certifier](/static/docs/guides/tools-ecosystem/certifier/12-certifier.png)
...
![13 - Certifier](/static/docs/guides/tools-ecosystem/certifier/13-certifier.png)
