...
![1 - Valid proof](/static/docs/guides/tools-ecosystem/validproof/1-validproof.png)

Scrolling down the main page, you'll find a concise explanation of how ValidProof works.

![2 - Valid proof](/static/docs/guides/tools-ecosystem/validproof/2-validproof.png)
...
![3 - Valid proof](/static/docs/guides/tools-ecosystem/validproof/3-validproof.png)

First, you must select or drag the file you want to verify on the file upload button.

![4 - Valid proof](/static/docs/guides/tools-ecosystem/validproof/4-validproof.png)

Then select the file for verification.

![5 - Valid proof](/static/docs/guides/tools-ecosystem/validproof/5-validproof.png)
...
![6 - Valid proof](/static/docs/guides/tools-ecosystem/validproof/6-validproof.png)

![7 - Valid proof](/static/docs/guides/tools-ecosystem/validproof/7-validproof.png)

- If the document was encrypted with a local certificate, the verifier must upload the certificate file to decrypt it.

![8 - Valid proof](/static/docs/guides/tools-ecosystem/validproof/8-validproof.png)

- If the document was encrypted using an AES key, the verifier must enter the associated password.

![9 - Valid proof](/static/docs/guides/tools-ecosystem/validproof/9-validproof.png)
...
![10 - Valid proof](/static/docs/guides/tools-ecosystem/validproof/10-validproof.png)

If the document is valid it will appear in green with a verified document message.

![11 - Valid proof](/static/docs/guides/tools-ecosystem/validproof/11-validproof.png)
...
![12 - Valid proof](/static/docs/guides/tools-ecosystem/validproof/12-validproof.png)

![13 - Valid proof](/static/docs/guides/tools-ecosystem/validproof/13-validproof.png)
